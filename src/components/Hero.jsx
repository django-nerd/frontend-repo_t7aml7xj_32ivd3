    ...
    <section id="home" className="relative min-h-[90vh] pt-24 flex items-center">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-10 items-center">
        <div className="space-y-6">
          <p className="inline-block rounded-full bg-slate-900 text-white px-4 py-1 text-sm">Open to opportunities</p>
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-slate-900">
            Hi, I'm <span className="text-blue-600">Your Name</span>
          </h1>
          <p className="text-xl text-slate-700">Data Analyst & Educational Content Creator</p>
          <p className="max-w-xl text-slate-600">I analyze complex datasets, craft clear insights, and create practical tutorials that help people learn data skills faster.</p>
